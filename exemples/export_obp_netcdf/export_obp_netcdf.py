...
if __name__ == "__main__":
    ...
    if run_halios:
        ...
        df, column_mapping = read_halios_first_deploy(
        ...
        # Export to NetCDF
        output_path = export_obp_to_netcdf(
            df_obp=df,
    ...
    if run_a0a_rbr:
        ...
        column_mapping = {
            "time": "Time",
            "pressure_seafloor": ["BPR pressure.1", "BPR pressure.2"],
            "temperature_sensor": ["BPR temperature.1", "BPR temperature.2"],
            "temperature_seawater": ["Temperature.1", "Temperature.2"],
