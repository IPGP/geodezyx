...
#### FCT DEF
def OrbDF_index_formater(OrbDFin,index_order=["sat","epoch"]):
    """
    From an Orbit DF generated by read_sp3(), set some columns 
...
def OrbDF_std_reformater(OrbDFin,index_order=["sat","epoch"]):
    """
...
def OrbDF_common_epoch_finder(OrbDFa_in,OrbDFb_in,return_index=False):
    ...
    """
    OrbDFa = OrbDF_index_formater(OrbDFa_in)
    OrbDFb = OrbDF_index_formater(OrbDFb_in)
